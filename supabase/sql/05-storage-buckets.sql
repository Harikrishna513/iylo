-- =============================================================================
-- IYLO Bakehouse | FILE 05 of 06 (OPTIONAL — run when you upload images to Storage)
-- 05-storage-buckets.sql
-- Creates Supabase Storage buckets + storage RLS policies
-- =============================================================================
-- IYLO Bakehouse â€” Supabase Storage buckets (optional; enable when using Storage)
